...
# inclusive of 200 and 400. The first variable represents the number of gallons of gas that the car's fuel
# tank holds. The second variable represents the miles that the car can travel on a full tank before needing a refuel.
from random import randint
tank_gallons = randint (10, 25)
tank_miles = randint(200, 400)
...
# In addition, display the values held in the variables you created for gallons of
# gas in the car's fuel tank and miles it can travel on a full tank with two different print statements.
def mpg(gallons, miles):
    return (miles//gallons)

print(str(tank_miles) + " miles driven on " + str(tank_gallons) + " gallons is ...")
print(str(mpg(tank_gallons, tank_miles)) + " miles per gallon")
