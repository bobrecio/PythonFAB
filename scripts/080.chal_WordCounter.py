...
#
# - Count the number of spaces in the filtered string and add 1 to that since the string will always contain
# at least 1 word.  This will give you the number of words it contains.
#
...
print(f"{count_words(str_1)} words in \"{str_1}\"")
print(f"{count_words(str_2)} words in \"{str_2}\"")
print(f"{count_words(str_3)} words in \"{str_3}\"")
