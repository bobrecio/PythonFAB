...
user_number = int(input("Enter a postive integer: "))
countdown = user_number
number_sum = 0
# The program should then use a while loop to get the sum of all of the integers from the integer that was
...
while countdown:
    number_sum += countdown
    countdown -= 1
# At the bottom of your program create two print statements.  One will display the user entered integer and
# the other will display the sum found by the while loop.
print ("Your number: " + str(user_number))
print (f"The sum of all integers up to {user_number} is {number_sum}")
